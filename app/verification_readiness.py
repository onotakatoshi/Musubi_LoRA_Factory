...
READINESS_FILES = {
    ...
    "process_env": ROOT / "app" / "process_env.py",
...
def verification_readiness() -> str:
    ...
    checks = [
        ...
        ("Environment check shows readiness", READINESS_FILES["env_check"], "## Verification readiness"),
        ("Environment check calls readiness", READINESS_FILES["env_check"], "verification_readiness()"),
        ...
        ("Training engine sets subprocess env", READINESS_FILES["training_engine"], "subprocess_env_overrides"),
        ("Subprocess env sets unbuffered logs", READINESS_FILES["process_env"], "PYTHONUNBUFFERED"),
        ("Subprocess env survives an unwritable Triton cache", READINESS_FILES["process_env"], "TRITON_CACHE_DIR"),
        ...
        ("PGX verify script runs desktop launch smoke test", READINESS_FILES["verify_script"], "desktop_launch_smoke_test.py"),
        ...
        ("Beta check runs environment static check", READINESS_FILES["check_beta"], "env_check_static_check.py"),
