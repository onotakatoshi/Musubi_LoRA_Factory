...
python -m py_compile app/desktop_main.py app/commands.py app/command_path_guard.py app/training_engine.py app/stage_guidance.py app/stage_guidance_static_check.py app/musubi_runtime_check.py app/env_check.py app/export_validator.py app/desktop_static_check.py app/verification_readiness.py
